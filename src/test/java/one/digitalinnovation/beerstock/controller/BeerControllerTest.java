...
public class BeerControllerTest {
    ...
    // Testando rotas e todos os métodos
    ...
    // Fazendo a configuração do mock antes de rodar os testes
    @BeforeEach
    void setUp() {
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        // then
        // Retornando todos os dados da requisição
    ...
    // Testa quando uma exceção (quando não existe a cerveja pesquisada)
    @Test
